import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-LRL5ANUX.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-DMX7U5MK.js";
import {
  LimitsModal
} from "./chunk-HMKDCZKE.js";
import {
...
} from "./chunk-3MV5PDV5.js";
import {
  useTypedSelector
} from "./chunk-FMFB74GP.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-2H7DYY73.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-BH26H2MZ.js";
import {
  index
} from "./chunk-USCCB3IQ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-347YZHZ3.js";
import {
  useConfig,
  useTracking
} from "./chunk-DGHM2DH4.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-NREMDRYE.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-JAOH4B6Z.js";
import {
  renderAdmin
} from "./chunk-NP6YDPRY.js";
import {
  useAIAvailability
} from "./chunk-7QHRY3PH.js";
import {
  useLicenseLimits
} from "./chunk-W7TI6U2P.js";
import {
  Table,
  useTable
} from "./chunk-CL2C3CC4.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-C2XYWIBZ.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-C55OUV2Y.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-PGWNNXG2.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-FKQBBZZR.js");
        return {
    ...
    _status: {
      message: (0, import_jsx_runtime18.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime18.jsx)(AITranslationStatusIcon, {
          ...
          variant: statusVariant,
          size: "S",
          children: (0, import_jsx_runtime18.jsx)(ForwardRef$o, {})
        })
      }),
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-62LG3TMN.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-QJIZLTEQ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-2B4GLJUH.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-SJOS2HAZ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-XA5VADJE.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-4LVH74IP.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-FTWS6AXZ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-4WFZ5QS7.js");
          return {
...
//# sourceMappingURL=chunk-U5PDRD6Z.js.map
