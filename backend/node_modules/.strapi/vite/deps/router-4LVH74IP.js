...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-PPI3WPRO.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-524GS2NL.js").then((mod) => ({
...
//# sourceMappingURL=router-4LVH74IP.js.map
