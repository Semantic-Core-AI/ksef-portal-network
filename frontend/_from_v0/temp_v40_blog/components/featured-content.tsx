        ...
        <Link href={`/article/${main.slug}`} className="lg:col-span-2 group cursor-pointer">
          ...
          >
            ...
            <div className="relative aspect-[21/9] overflow-hidden">
              <img
                src={main.thumbnail || "/placeholder.svg"}
                alt={main.title}
            ...
            <div className="p-8">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-[#6B7280]">
                <span className="flex items-center gap-1">
                  <BookOpen className="h-4 w-4" /> {main.readingTime} min czytania
                </span>
                <span className="flex items-center gap-1">
                  <Star className="h-4 w-4 fill-[#C7A83B] text-[#C7A83B]" /> {main.rating.average}/5 (
                  {main.rating.count})
                </span>
                <span className="flex items-center gap-1">
                  <Eye className="h-4 w-4" /> {formatNumber(main.views)} wyświetleń
                </span>
                <span className="flex items-center gap-1">
                  <MessageCircle className="h-4 w-4" /> {main.commentsCount} komentarzy
                </span>
              </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-3 text-xs text-[#6B7280]">
                  ...
                  <span>⭐ {article.rating.average}/5</span>
