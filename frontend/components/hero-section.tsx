...
export function HeroSection({ onCategorySelect, selectedCategories, onSearch }: HeroSectionProps) {
  ...
  return (
    <section className="relative bg-gradient-to-br from-[#0A1628] via-[#0F1B3A] to-[#1E2A5E] pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden">
      ...
      <div className="relative z-10 container max-w-[1280px] mx-auto px-4" suppressHydrationWarning>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-display)] font-bold text-white mb-6 leading-[1.1] flex items-center gap-3">
          <BookOpen className="h-10 w-10 md:h-12 md:w-12 text-[#C7A83B]" />
          <span className="text-[#C7A83B]">Prawdziwa</span> Baza Wiedzy
        </h1>
        ...
        {/* Search Bar */}
        <div className="relative max-w-3xl mb-7">
