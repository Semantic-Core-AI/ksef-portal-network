...
import type { CardVariant } from "@/lib/blog-types"
...
import { getCategoryColor, formatRelativeDate, formatNumber } from "@/lib/blog-helpers"
            ...
            <div className="flex items-center justify-between pt-4 border-t border-[#F5F5F5] mt-auto">
              ...
              <div className="flex items-center gap-2">
                <img
                  src={
                    article.author?.avatar?.url
                      ? `${process.env.NEXT_PUBLIC_STRAPI_URL || 'http://localhost:1337'}${article.author.avatar.url}`
                      : "/placeholder.svg"
                  }
                ...
                <div className="text-xs">
                  ...
                  <p className="text-[#6B7280]">{article.author?.role || "Autor"}</p>
                </div>
              </div>
